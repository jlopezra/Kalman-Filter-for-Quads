function [sys,x0,str,ts,simStateCompliance] = quadSim12state(t,x,u,flag,P,Pos)
...
switch flag,
  ...
  %%%%%%%%%%%%%%%%%%
  case 0,
    [sys,x0,str,ts,simStateCompliance]=mdlInitializeSizes(P,Pos);
...
%=============================================================================
%
function [sys,x0,str,ts,simStateCompliance]=mdlInitializeSizes(P,Pos)
...
%=============================================================================
%
function xdot=mdlDerivatives(t,x,in,P)
F_thrust = P.m*in(1);
tauPhi = in(2);
tauTheta = in(3);
tauPsi = in(4);
